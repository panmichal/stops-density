Simple [Dash](https://dash.plotly.com/) application that calculates public transport stops density in each provided area and renders a chloropleth map based on the result.
