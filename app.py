...
app.layout = [
    html.Div([
        ...
        dbc.Row(dbc.Col(html.Div([dcc.Graph(id="graph", style={"height": "100%"})])), justify="center"),
        dbc.Row(dbc.Col(html.Div([dcc.Graph(id="graph-scatter", style={"height": "100%"})])), justify="center")
        ])
]
